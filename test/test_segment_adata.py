...
class TestSetupLogging:
    ...
    def test_creates_log_directory(self, temp_dir):
        ...
        from ezsp.tg_adata import setup_logging
...
class TestLoadConfig:
    ...
    def test_loads_yaml_config(self, temp_dir, sample_config):
        ...
        import yaml
        from ezsp.tg_adata import load_config
...
class TestPrepareForSquidpy:
    ...
    def test_creates_spatial_metadata(self, mock_adata, sample_rgb_image):
        ...
        from ezsp.tg_adata import prepare_for_squidpy
        ...
        with patch('ezsp.tg_adata.normalize_image', side_effect=lambda x, compute: x):
...
class TestSegmentAndExtractFeatures:
    ...
    def test_adds_cell_count(self, mock_adata_with_spatial):
        ...
        from ezsp.tg_adata import segment_and_extract_features
        ...
        with patch('ezsp.tg_adata.sq.im.ImageContainer') as mock_imgc:
            with patch('ezsp.tg_adata.sq.im.segment'):
                with patch('ezsp.tg_adata.sq.im.calculate_image_features') as mock_calc:
                    ...
                    result, imgc = segment_and_extract_features(
...
class TestPrepareSingleCellReference:
    ...
    def test_filters_cell_types(self, mock_sc_adata, temp_dir):
        ...
        from ezsp.tg_adata import prepare_single_cell_reference
